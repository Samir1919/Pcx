...
function service(overrides={}){return{async createCategory(_a,input){return{id:"c1",...input,status:"ACTIVE"};},async createBrand(_a,input){return{id:"b1",...input,status:"ACTIVE"};},async createProductModel(_a,input){return{id:"m1",...input,status:"ACTIVE"};},async archive(){},...overrides};}
