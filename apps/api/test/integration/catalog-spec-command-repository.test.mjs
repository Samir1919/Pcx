...
test("spec commands persist typed values and actor audits atomically",{skip:!connectionString},async()=>{
  ...
  try{
    ...
    const record={id:definition,categoryId:category,key:"capacity_test_gb",label:"Capacity",dataType:"NUMBER",unit:"GB",filterable:true,required:false,sortOrder:1,status:"ACTIVE",createdAt:now};
