...
test("spec commands persist typed values and actor audits atomically",{skip:!connectionString},async()=>{
  ...
  const actor="76000000-0000-4000-8000-000000000001",category="76000000-0000-4000-8000-000000000002",brand="76000000-0000-4000-8000-000000000003",model="76000000-0000-4000-8000-000000000004",definition="76000000-0000-4000-8000-000000000005",value="76000000-0000-4000-8000-000000000006",setId="76000000-0000-4000-8000-000000000010",now="2026-08-16T00:00:00.000Z";
  ...
  try{
    ...
    assert.equal((await pool.query("SELECT count(*)::int AS count FROM auth_audit_events WHERE actor_id=$1",[actor])).rows[0].count,6);
