        ...
        ? createPortal(
          <div className="modalOverlay" onClick={() => setOpen(false)}>
            ...
            >
              ...
              <p>
                A <strong>public passport</strong> is a verified condition report that travels with each item. It
                shows the item's grade, health score, and the checks it passed.
              </p>
