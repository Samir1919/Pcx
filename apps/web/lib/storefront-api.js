...
export const storefrontApi = Object.freeze({
  ...
  referenceValues: () => request("/api/v1/reference-values"),
  compatibilityRules: () => request("/api/v1/compatibility-rules"),
  ...
  submitSellRequest: (sellRequestId) => request(`/api/v1/sell-requests/${encodeURIComponent(sellRequestId)}/submit`, { method: "POST", body: {}, headers: csrfHeaders() }),
  mySellRequests: () => request("/api/v1/sell-requests"),
  sellRequest: (sellRequestId) => request(`/api/v1/sell-requests/${encodeURIComponent(sellRequestId)}`),
  sellRequestOffers: (sellRequestId) => request(`/api/v1/sell-requests/${encodeURIComponent(sellRequestId)}/offers`),
