...
SUBMITTED → REVIEWING → INSPECTION_REQUIRED → INSPECTING → OFFERED → ACCEPTED/REJECTED → PAID/CLOSED.
...
Sell Request:
DRAFT → SUBMITTED → REVIEWING → INSPECTION_REQUIRED → INSPECTING → OFFERED → ACCEPTED → PAID → CLOSED
