...
9. **E14/E16 reporting & audit** — full BI/reporting UI, scheduled exports, external SIEM.
10. **E17 security** — upload scanning, ~~HSTS~~ (done), ~~CSP allowlisting for admin UI~~ (done 2026-09-01), MFA gates (hard stop).
