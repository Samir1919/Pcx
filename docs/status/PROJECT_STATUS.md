...
2. **Refund gateway adapter execution (E12, sandbox)** — wire an injected sandbox refund gateway behind the existing settleRefund flow (domain/repo/HTTP already complete).
