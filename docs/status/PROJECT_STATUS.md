...
- Updated: 2026-09-01
- Current main evidence commit: `af30ddc` (passport verification summary + scan-to-open QR, E7/E8, merged into `origin/main`)
...
7. **E11 fulfilment** — packaging evidence media, return-to-origin.
