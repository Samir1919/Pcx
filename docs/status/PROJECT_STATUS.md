...
- Remaining (non-blocking): `selected_specs` sell-flow capture (the S04 "Variant/Specs" step is declared in domain/service but the storefront never submits it); reusable/global attributes (attribute sets) + enum/select data types.
