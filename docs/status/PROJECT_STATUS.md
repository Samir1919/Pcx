...
- Updated: 2026-09-01
- Current main evidence commit: `ffe1f77` (claim inspection link, E13, merged into `origin/main`)
...
| E17 — Security hardening | In progress | Baseline response security headers (`nosniff`, `DENY`, `no-referrer`, restrictive CSP, HSTS, `permissions-policy`) with regression coverage | Upload scanning, CSP allowlisting for admin UI, MFA gates |
...
10. **E17 security** — upload scanning, ~~HSTS~~ (done 2026-09-01), CSP allowlisting for admin UI, MFA gates.
