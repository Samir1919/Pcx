...
3. **Real bKash HTTP adapter (E10)** — implement a real bKash HTTP adapter behind the injected gateway contract (sandbox-only until real credentials are approved); plus refunds + reconciliation.
