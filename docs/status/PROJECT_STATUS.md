...
- Updated: 2026-09-01
- Current main evidence commit: `407a985` (sandbox refund gateway behind settleRefund, E12, merged into `origin/main`)
...
4. **E5 inspection follow-ups** — reinspection/supersede, reasoned supervisor override (critical-fail), and technician autosave.
