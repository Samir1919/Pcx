...
- Updated: 2026-09-01
- Current main evidence commit: `e764663` (packaging evidence media + return-to-origin, E11, merged into `origin/main`)
...
8. **E13 warranty** — warranty policy authoring, claim inspections, carrier pickup, cost accounting.
