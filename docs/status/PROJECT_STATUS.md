...
- ADR 0010 Open marketplace "advertise & sell" flow: Proposed (hard stop — full marketplace/advertise implementation awaits human approval plus a `BUSINESS_PRODUCT_REQUIREMENTS.md` phase-boundary change).
- Current blocker: marketplace/advertise product decision pending (no code blocked for the Sell-to-PCX path).
