...
- Updated: 2026-09-01
- Current main evidence commit: `cd5193e` (server-derived order shipping/tax allocation, E9, merged into `origin/main`)
...
10. **E17 security** — upload scanning, HSTS, CSP allowlisting for admin UI, MFA gates.
