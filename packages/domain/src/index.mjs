...
export { assertRequiredSpecificationValues, assertUniqueModelSpecificationValues, attributeGroupLabel, createAttributeSet, createAttributeSetItem, createModelSpecificationValue, createSpecificationDefinition, SpecificationDataType } from "./catalog/specifications.mjs";
